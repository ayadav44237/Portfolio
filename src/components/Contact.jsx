...
export default function Contact() {
  return (
    <AnimatedSection as="section" className="contact" id="contact" stagger>
      ...
      <div className="contact__content">
        ...
        <div className="contact__links">
          <a href="mailto:ayadav44237@gmail.com" className="contact__item">
            ...
            <span>ayadav44237@gmail.com</span>
          </a>
          <a href="tel:+916393830091" className="contact__item">
            <span className="contact__icon">
            ...
            <span>+91 6393830091</span>
          </a>
          <a href="https://linkedin.com/in/ayadav44237/" target="_blank" rel="noopener noreferrer" className="contact__item">
            <span className="contact__icon">
          ...
          <a href="https://github.com/ayadav44237" target="_blank" rel="noopener noreferrer" className="contact__item">
            <span className="contact__icon">
